...
class GUI_SelectDataFrameForTable (wx.Frame):

    def __init__(self, lst_of_dataFrame_names):
        wx.Frame.__init__(self, None, id=wx.ID_ANY, title=u"DataFrame Selection", pos=wx.DefaultPosition, size=wx.Size(400, 205), style=wx.CAPTION | wx.FRAME_FLOAT_ON_PARENT | wx.TAB_TRAVERSAL)
        ...
        dataFrame_ListBoxChoices = lst_of_dataFrame_names
        ...
        m_sdbSizer8.Realize()
        bSizer122.Add(m_sdbSizer8, 0, wx.ALL | wx.EXPAND, 5)

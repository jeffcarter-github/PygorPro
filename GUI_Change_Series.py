...
class GUI_Change_Series_Type (wx.Frame):
    ...
    def __init__(self, parent):
        wx.Frame.__init__(self, parent, id=wx.ID_ANY, title=u"Change Series Type", pos=wx.DefaultPosition, size=wx.Size(400, 430), style=wx.CAPTION | wx.FRAME_FLOAT_ON_PARENT | wx.TAB_TRAVERSAL)
